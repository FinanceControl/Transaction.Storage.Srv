...
public class NewAssetTypeAddEventHandler : IRequestHandler<NewAssetTypeAddEvent, Result<AssetTypeDto>>
{
    private readonly IRepositoryBase<AssetType> repository;

    public NewAssetTypeAddEventHandler(IRepositoryBase<AssetType> repository){
        this.repository = repository;
    }

    public async Task<Result<AssetTypeDto>> Handle(NewAssetTypeAddEvent request, CancellationToken cancellationToken)
    {
