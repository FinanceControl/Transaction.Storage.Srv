...
public static class SwaggerGenOptionsInit
{
  ...
  public const string AssetAggregate = nameof(Transaction.Storage.Srv.App.Core.Aggregates.AssetAggregate);
  public const string AccountAggregate = nameof(Transaction.Storage.Srv.App.Core.Aggregates.AccountAggregate);
  ...
  public static void Init(this SwaggerGenOptions options)
  {
    ...
    options.SwaggerDoc(nameof(Transaction.Storage.Srv.App.Core.Aggregates.AssetAggregate), new OpenApiInfo
    {
      Version = Version,
